...
export const BUILTIN_API_ITEMS: ApiItem[] = [
  createBuiltinApi('provider-netease', '网易云音乐', 'info', '获取歌曲信息', 'source=netease&id=<songId>'),
  createBuiltinApi('provider-netease', '网易云音乐', 'search', '搜索歌曲', 'source=netease&keyword=<keyword>&limit=20'),
  createBuiltinApi('provider-netease', '网易云音乐', 'playlist', '获取歌单详情', 'source=netease&id=<playlistId>'),
  ...
  createBuiltinApi('provider-kuwo', '酷我音乐', 'info', '获取歌曲信息', 'source=kuwo&id=<songId>'),
  createBuiltinApi('provider-kuwo', '酷我音乐', 'search', '搜索歌曲', 'source=kuwo&keyword=<keyword>&limit=20'),
  createBuiltinApi('provider-kuwo', '酷我音乐', 'playlist', '获取歌单详情', 'source=kuwo&id=<playlistId>'),
  ...
  createBuiltinApi('provider-qq', 'QQ 音乐', 'info', '获取歌曲信息', 'source=qq&id=<songMid>'),
  createBuiltinApi('provider-qq', 'QQ 音乐', 'search', '搜索歌曲', 'source=qq&keyword=<keyword>&limit=20'),
  createBuiltinApi('provider-qq', 'QQ 音乐', 'playlist', '获取歌单详情', 'source=qq&id=<playlistId>'),
  ...
  createBuiltinApi('provider-bilibili', 'Bilibili', 'info', '获取歌曲信息', 'source=bilibili&id=<bvid>'),
  createBuiltinApi('provider-bilibili', 'Bilibili', 'search', '搜索歌曲', 'source=bilibili&keyword=<keyword>&limit=20'),
  createBuiltinApi('provider-bilibili', 'Bilibili', 'playlist', '获取歌单详情', 'source=bilibili&id=<playlistId>'),
  createBuiltinApi('provider-bilibili', 'Bilibili', 'toplists', '获取排行榜列表', 'source=bilibili'),
  createBuiltinApi('provider-bilibili', 'Bilibili', 'toplist', '获取排行榜歌曲', 'source=bilibili&id=<toplistId>'),
  createBuiltinApi('provider-bilibili', 'Bilibili', 'url', '获取音频 URL', 'source=bilibili&id=<bvid>&br=320k'),
];
